...
Module modChess1
    ...
    '    Public Const MaxX As Short = 8 '(Defined elsewhere) Horizontal board dimension - File
    '    Public Const MaxY As Short = 8 '(Defined elsewhere) Vertical board dimension - Rank
